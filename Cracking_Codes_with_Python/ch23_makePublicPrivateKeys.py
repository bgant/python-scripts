# "Textbook" Public/Private Key Generator (Based on RSA algorithm)
# https://www.nostarch.com/crackingcodes/ (BSD Licensed)

import random
import sys
import os
import ch22_primeNum as primeNum
...
def generateKey(keySize):
    ...
    # Step 1: Create two prime numbers, p and q and
    # Calculate n = p * q
    print('Generating p and q large primes...')
    while p == q:
...
# If makePublicPrivateKeys.py is run (instead of imported as a module), call the main() function
