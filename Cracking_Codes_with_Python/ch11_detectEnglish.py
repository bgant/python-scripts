# Detect English module (using "space" as delimiter)
...
# https://www.nostarch.com/crackingcodes/ (48K words) or symlink to
# ln -s /usr/share/dict/words dictionary.txt (234K words)
