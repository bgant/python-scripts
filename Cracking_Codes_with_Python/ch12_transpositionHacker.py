...
import ch11_detectEnglish, ch08_transpositionDecrypt
...
def hackTransposition(message):
    ...
    for key in range(1, len(message)):
        ...
        decryptedText = ch08_transpositionDecrypt.decryptMessage(key, message)

        if ch11_detectEnglish.isEnglish(decryptedText):
